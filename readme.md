To calculate the mean and standard error (SE), all data are merged into a single csv file, and the "Batch Analysis MeanSEMP.r" script should be executed. Both files should be in the same folder.
